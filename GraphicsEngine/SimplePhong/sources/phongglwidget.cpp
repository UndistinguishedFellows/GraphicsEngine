...
PhongGLWidget::PhongGLWidget(QWidget *parent) : QOpenGLWidget(parent)
{
...
void PhongGLWidget::SelectCameraType(CameraType type)
{
	m_cameraType = type;
}
...
void PhongGLWidget::computeBBoxScene()
{
...
void PhongGLWidget::sceneTransform()
{
